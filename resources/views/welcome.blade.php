               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="#general-element" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>m_level</p>
            ...
            <section class="content">
                ...
                <div class="card card-warning">
                    <div class="card-header">
                        <h3 class="card-title" id="general-element">General Elements</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label>Level id</label><input type="text" class="form-control"
                                            placeholder="id">
                                        <div>
                                        </div>
                ...
                <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title" id="m-user">M-user</h3>
                </div>
                <div class="row">
                    <div class="col-md-12">
                      <form>
              ...
              <div class="card card-warning">
                <div class="card-header">
                  <h3 class="card-title" id="m-user">M-level</h3>
              </div>
              <div class="row">
                  <div class="col-md-12">
                    <form>
